...
exports.up = async function(knex) {
    ...
    await knex('accounts').insert({
      ...
      await knex('loans').insert({
        id: "16c2ec38-aa8e-4793-bbbb-0d0879cd3eab",
        loan_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        loan_amount: 5678900000000000000000,
        collateral_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        collateral_amount: 400000000000000000000,
        collateral_current_amount:400000000000000000002,
        borrow_interest:1.2222,
        commitment: "0x636f6d69745f4e4f4e4500000000000000000000000000000000000000000000",
        cdr: 0.66666,
        debt_category: 2,
      ...
      await knex('loans').insert({
        id: "16c2ec38-aa8e-4793-bbbb-0d0879cd3eac",
        loan_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        loan_amount: 5678900000000000000000,
        collateral_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        collateral_amount: 600000000000000000000,
        collateral_current_amount:600000000000000000002,
        borrow_interest:1.2222,
        commitment: "0x636f6d69745f4e4f4e4500000000000000000000000000000000000000000000",
        cdr: 0.66666,
        debt_category: 2,
        current_amount: 700000000000000000000,
        current_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        is_swapped: false,
        loan_status_id: 2,
        account_address: "0x317A69fA54E8e7113326E897DF6204ef2129a3A7",
      ...
      await knex('loans').insert({
        id: "16c2ec38-aa8e-4793-bbbb-0d0879cd3ead",
        loan_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        loan_amount: 5678900000000000000000,
        collateral_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        collateral_amount: 600000000000000000000,
      ...
      await knex('loans').insert({
        id: "16c2ec38-aa8e-4793-bbbb-0d0879cd3eae",
        loan_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        loan_amount: 5678900000000000000000,
        collateral_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        collateral_amount: 600000000000000000000,
      ...
      await knex('loans').insert({
        id: "16c2ec38-aa8e-4793-bbbb-0d0879cd3eaf",
        loan_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        loan_amount: 5678900000000000000000,
        collateral_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        collateral_amount: 600000000000000000000,
      ...
      await knex('loans').insert({
        id: "16c2ec38-aa8e-4793-bbbb-0d0879cd3ea9",
        loan_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        loan_amount: 5678900000000000000000,
        collateral_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        collateral_amount: 600000000000000000000,
      ...
      await knex('loans').insert({
        id: "16c2ec38-aa8e-4793-bbbb-0d0879cd3ea8",
        loan_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        loan_amount: 5678900000000000000000,
        collateral_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        collateral_amount: 600000000000000000000,
      ...
      await knex('loans').insert({
        id: "16c2ec38-aa8e-4793-bbbb-0d0879cd3ea7",
        loan_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        loan_amount: 3454565600000000000000000,
        collateral_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        collateral_amount: 600000000000000000000,
        collateral_current_amount:600000000000000000002,
        borrow_interest:1.2222,
      ...
      await knex('loans').insert({
        ...
        loan_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        loan_amount: 245475600000000000000000,
        collateral_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        collateral_amount: 600000000000000000000,
        collateral_current_amount:600000000000000000002,
        borrow_interest:1.2222,
      ...
      await knex('loans').insert({
        id: "16c2ec38-aa8e-4793-bbbb-0d0879cd3ea5",
        loan_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        loan_amount: 5465600000000000000000,
        collateral_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        collateral_amount: 600000000000000000000,
        collateral_current_amount:600000000000000000002,
        borrow_interest:1.2222,
      ...
      await knex('loans').insert({
        id: "16c2ec38-aa8e-4793-bbbb-0d0879cd3ea4",
        loan_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        loan_amount: 5677600000000000000000,
        collateral_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        collateral_amount: 600000000000000000000,
        collateral_current_amount:600000000000000000002,
        borrow_interest:1.2222,
      ...
      await knex('loans').insert({
        id: "16c2ec38-aa8e-4793-bbbb-0d0879cd3ea3",
        loan_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        loan_amount: 6000000,
        collateral_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        collateral_amount: 600000000000000000000,
      ...
      await knex('loans').insert({
        id: "16c2ec38-aa8e-4793-bbbb-0d0879cd3ea2",
        loan_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        loan_amount: 30000,
        collateral_market: "0x555344542e740000000000000000000000000000000000000000000000000000",
        collateral_amount: 600000000000000000000,
